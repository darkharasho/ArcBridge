        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="w-full max-w-4xl mx-4 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent shadow-[0_20px_80px_rgba(0,0,0,0.6)]"
                >
