...
function App() {
    ...
    /**
     * A native re-parse succeeded for these files. The healed details are
    ...
    const appLayoutCtx = useMemo(() => ({
        ...
        aggregationDiagnostics, nativeCoverage, handleLogsHealed,
