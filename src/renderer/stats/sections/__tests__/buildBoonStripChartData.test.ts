...
const fights = [
    { id: 'a', mapName: 'EBG', label: 'F1', duration: '01:00', isWin: true, totalOutgoingStrips: 20, totalIncomingStrips: 6, totalBoonsApplied: 9 },
    { id: 'b', mapName: 'Hills', label: 'F2', duration: '02:00', isWin: false, totalOutgoingStrips: 4, totalIncomingStrips: 10, totalBoonsApplied: 30 },
];
...
describe('buildBoonStripChartData', () => {
    ...
    it('uses boons applied for the up series in applied mode', () => {
        const data = buildBoonStripChartData(fights, 'applied');
