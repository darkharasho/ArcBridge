    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 z-[72] flex items-center justify-center bg-black/70 backdrop-blur-md"
            ...
            >
                <motion.div
                    ...
                    className="w-full max-w-3xl mx-4 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900/95 to-blue-950/40 shadow-[0_20px_80px_rgba(0,0,0,0.6)]"
                >
