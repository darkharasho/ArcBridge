 ...
 */
export function readPaletteFromReport(stats: any): { palette: ColorPalette; glass: boolean; glassmorphic: boolean } {
    ...
    if (stats?.reportTheme?.ui) {
        ...
        if (mapping) return { ...mapping, glassmorphic: false };
    }
    ...
    return { palette: DEFAULT_PALETTE_ID, glass: false, glassmorphic: false };
}
